...
export const supabasePilotProfile: OnboardingProfile = {
  companyName: "Supabase",
  industry: "Developer platform",
  companySize: "enterprise",
  useCase: "product-api-assistant",
  stage: "pilot",
  integrationMode: "backend-worker",
  sources: allCatalogItems.map((item) => item.id),
  compliance: ["SOC 2", "HIPAA", "SSO / identity controls"],
  systems: ["developer-portal", "api-gateway", "website", "status-feed"],
};

export const publicPilot = {
  company: "Supabase",
  dateLabel: "April 23, 2026",
  verdict: "Recommended public-data pilot",
  summary:
    "Supabase is a strong onboarding target because its public corpus covers platform positioning, developer docs, API reference, security guidance, pricing/billing, changelog activity, community signals, careers, contact paths, and legal surfaces.",
  metrics: [
    { label: "Pages scraped in staging", value: "12" },
    { label: "Supabase topics added", value: "11" },
    { label: "Supabase characters captured", value: "26.7k" },
    { label: "Working verdict", value: "High public-source fit" },
  ],
  notes: [
    "The staging crawl captured homepage, docs, database, auth, edge functions, storage, realtime, vector, data API, and contact/demo surfaces.",
    "Official pricing, security, changelog, API reference, careers, and legal pages are publicly available for the next enrichment pass.",
    "The current workspace still contains old sample coffee-shop data and no usable model credentials, so the deeper answer-quality benchmark should happen after dataset cleanup and credential setup.",
  ],
  links: [
    {
      label: "Platform",
